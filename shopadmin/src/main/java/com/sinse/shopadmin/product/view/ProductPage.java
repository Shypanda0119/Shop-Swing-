...
public class ProductPage extends Page {
	...
	public ProductPage(AppMain app) {
		...
		la_brand = new JLabel("상품 브랜드");
		la_price = new JLabel("상품 가격");
		la_discount = new JLabel("상품 할인가");
		la_color = new JLabel("상품 색상");
		la_size = new JLabel("상품 사이즈");
	...
	public void preview() {
		...
		if (files.length > 6) {
			JOptionPane.showMessageDialog(this, "이미지는 최대 6까지 가능합니다.");
		} else {
